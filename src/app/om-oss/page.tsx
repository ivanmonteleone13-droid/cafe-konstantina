...
export const metadata: Metadata = {
  title: "Om oss",
  description: `Lär känna ${business.name} — café på Svartbäcksgatan 24, Uppsala.`,
};
    ...
    <>
      ...
      <section className="bg-[#faf7f2] py-20">
        <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
          ...
          <p className="mt-4 text-[#6f4e37]/70">Ring {business.phone} eller besök oss på Svartbäcksgatan 24.</p>
