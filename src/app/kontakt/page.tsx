...
export const metadata: Metadata = {
  title: "Kontakt",
  description: `Kontakta ${business.name} på Svartbäcksgatan 24 i Uppsala. Ring oss.`,
};
      ...
      <section className="bg-gradient-to-br from-[#3d2914] to-[#6f4e37] py-20 text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="mt-6 max-w-2xl text-lg text-white/90">
            Vi finns på Svartbäcksgatan 24 i Linnékvarteret, Uppsala.
          </p>
        </div>
      </section>
          ...
          <div>
            ...
            <dl className="mt-8 space-y-6">
              ...
              {business.facebookUrl && (
                <div>
                  <dt className="text-sm font-medium text-[#6f4e37]/60">Facebook</dt>
                  <dd>
                    <a
