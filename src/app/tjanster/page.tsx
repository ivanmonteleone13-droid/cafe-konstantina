...
export const metadata: Metadata = {
  title: "Utbud",
  description: `Fika och lunch hos ${business.name} i Uppsala.`,
};
      ...
      <section className="bg-gradient-to-br from-[#3d2914] to-[#6f4e37] py-20 text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="mt-6 max-w-2xl text-lg text-white/90">
            Fikabröd, smörgåsar, sallader, pajer och lunch — servering på två våningar.
          </p>
        </div>
      </section>
      <section className="py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-12 space-y-4 rounded-2xl border border-[#d4a574]/30 bg-[#faf7f2] p-6 text-sm text-[#3d2914]">
            <p>
              <strong>Ring oss:</strong> {business.phone}
            </p>
          </div>
